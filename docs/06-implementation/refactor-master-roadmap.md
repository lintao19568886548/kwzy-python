...
11. `complete-workforce-scheduling-attendance-performance`：实现 `370c7f8`、验收扩展 `5577509`；唯一 head `c5f02d8e9c87`，精确提交 37/37、380 后端、62 浏览器、28 个 workforce 路径、36 阶段真实 HTTP、1000/25 p95 264.836 ms/145.596 RPS/0 错误、1,697,402 bytes/162 表备份恢复和 HR 合成 ETL 通过；本地产品纵切关闭，真实设备/旧数据仍 NOT_CONNECTED/BLOCKED。
