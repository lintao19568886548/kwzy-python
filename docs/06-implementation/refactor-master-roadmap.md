...
| 服务与运营业务 | Party 绑定租户服务、员工/租户受理、规则派单/改派、SLA、报价、追加式成本、完工证据、返工/验收/评价及 PC 真栈 | 设备台账、周巡检、IoT 告警；员工移动端；库存/供应商联动；HR、供应链、园企服务 | TENANT_SERVICE_CLOSED_LOCAL_PRODUCT_SCOPE / REMAINDER_MISSING |
...
12. 集成负责人提供沙箱协议和短期凭据；SRE 在获批预发完成容量、监控告警和灾备。只有能力矩阵无 `MISSING/BLOCKED`、三端关键旅程通过、P0/P1=0 且生产部署另获人工授权后，才能非强制合并 main 并在最终 main 重验。
