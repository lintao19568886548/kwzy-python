...
| `KWZY_DATA_MIGRATION_READINESS` | `READY_FIXTURE`（fixture dry-run/apply/checkpoint/对账/回滚演示） |
| `KWZY_LOCAL_STAGING_EQUIVALENT` | `PASS`（`infra/local-staging/run_local_staging.ps1`） |
