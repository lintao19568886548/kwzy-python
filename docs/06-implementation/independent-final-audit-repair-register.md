...
> 最新精确提交验收：HR/排班/考勤/绩效/资质 `5577509a6ca2a473107038be1316a0ea9252fc8d` 的 37/37 门禁、380 后端、62 浏览器、36 阶段真实 HTTP、性能、备份恢复、OpenAPI/OpenSpec 与 1,091 文件密钥扫描通过。
...
| CAP-003 | 其余组合业务闭环缺失 | HR 本地纵切关闭后，能力矩阵仍有 7 项为 MISSING | 按矩阵逐项实现，或取得有依据/责任人的退休或延期批准 | 产品/领域负责人（待指定）；MISSING |
