...
> 最新精确提交验收：档案/签章/印章 `83697f99d3ca3b55f726b8ae2db246347d0919e8` 的 35/35 门禁、366 后端、61 浏览器、性能、备份恢复、OpenAPI/OpenSpec 与 1,039 文件密钥扫描通过；实现和修复已正常推送。
...
| RECORDS-001 | P1 | 现仓只有附件元数据和合同 fake 签章，缺档案保管/借阅/处置、印章保管/用印和可证明的签章真相 | 新增 16 张表、两条前向迁移、33 个受控 API 方法、PC 真栈与合成迁移；精确 `83697f9` 的 366 pytest、61 Playwright、21/21 真实 HTTP 和 35/35 总门禁通过 | CLOSED_LOCAL_PRODUCT_SCOPE |
