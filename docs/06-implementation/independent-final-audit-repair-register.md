...
> 最新精确提交验收：设施设备/巡检/IoT `e28678b5785b7f8bf03141bd7cffbd162932315b` 的 35/35 门禁、352 后端、60 浏览器、性能、备份恢复、OpenAPI/OpenSpec 与 982 文件密钥扫描通过；实现已正常推送。
...
| CAP-003 | 其余组合业务闭环缺失 | 设施设备/巡检/IoT 本地纵切关闭后，能力矩阵仍有 9 项为 MISSING | 按矩阵逐项实现，或取得有依据/责任人的退休或延期批准 | 产品/领域负责人（待指定）；MISSING |
