# party-test-matrix Specification

## Purpose

Define fast, PostgreSQL, isolation, permission, contract, and regression test gates for Party master.
...
- **WHEN** Party delivery tasks are reviewed
- **THEN** the PostgreSQL gate tasks are listed before complete status
...
Completion SHALL require the full existing foundation pytest suite plus Party tests to pass on the intended tracks.
