# party-openapi-contract Specification

## Purpose

Define stable Party ownership and address semantics in the formal OpenAPI contract.
...
Existing draft or stub OpenAPI Party.park_id SHALL be removed from the new formal contract or must not remain a source of truth. Compatibility adapters for legacy rental APIs are outside Party master scope.
