...
python tools/etl/run_crm_etl_drill.py --database-url postgresql+psycopg://... --out infra/local-staging/out/crm_etl/crm_etl.json
```
...
核心、Identity、资产与招商 CRM 合成数据已具备校验、首次应用、幂等重跑、对账与隔离回滚演练；
