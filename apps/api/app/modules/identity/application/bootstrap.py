...
DEFAULT_PERMISSIONS = (
    ...
    ("bill:generate", "从合同计划自动出账", "billing"),
    ("payment:read", "查看收款登记", "collection"),
    ("payment:write", "登记收款与核销", "collection"),
    ("payment:import", "导入到账流水", "collection"),
    ("payment:review", "复核到账匹配", "collection"),
    ("payment:allocate", "分配预收余额", "collection"),
    ("payment:dispute_review", "复核到账业务争议", "collection"),
    ...
    ("work_order:intake", "受理租户服务请求", "facility_ops"),
    ("work_order:dispatch", "派发与改派工单", "facility_ops"),
    ("work_order:dispatch_rule_manage", "维护派单规则", "facility_ops"),
    ("work_order:execute", "执行工单并登记成本", "facility_ops"),
    ("work_order:quote", "编制与提交工单报价", "facility_ops"),
    ("work_order:sla_sweep", "执行工单 SLA 扫描", "facility_ops"),
    ("facility_device:read", "查看设备台账", "facility_ops"),
    ("facility_device:write", "维护设备台账", "facility_ops"),
    ("facility_device:retire", "退役设备", "facility_ops"),
    ("inspection:read", "查看巡检", "facility_ops"),
    ("inspection:template_manage", "维护巡检模板", "facility_ops"),
    ("inspection:schedule_manage", "维护巡检计划", "facility_ops"),
    ("inspection:execute", "执行巡检", "facility_ops"),
    ("inspection:dispatch", "改派巡检与转工单", "facility_ops"),
    ("inspection:sweep", "生成巡检任务与逾期扫描", "facility_ops"),
    ("iot:provider_manage", "维护 IoT 提供方", "facility_ops"),
    ("iot:binding_manage", "维护 IoT 设备绑定", "facility_ops"),
    ("iot:ingest", "接收 IoT 告警事件", "facility_ops"),
    ("iot:alarm_read", "查看 IoT 告警", "facility_ops"),
    ("record:read", "查看档案", "records_seal"),
    ("record:write", "创建档案与版本", "records_seal"),
    ("record:manage", "维护档案分类", "records_seal"),
    ("record:verify", "执行档案完整性校验", "records_seal"),
    ("record:hold", "设置与解除档案保全", "records_seal"),
    ("record:access_request", "申请档案访问与借阅", "records_seal"),
    ("record:access_review", "查看档案访问申请", "records_seal"),
    ("record:access_execute", "执行档案借出与归还", "records_seal"),
    ("record:dispose_request", "申请档案处置", "records_seal"),
    ("record:dispose_review", "查看档案处置申请", "records_seal"),
    ("record:dispose_confirm", "执行档案处置双人确认", "records_seal"),
    ("seal:read", "查看印章与用印台账", "records_seal"),
    ("seal:manage", "维护印章台账与状态", "records_seal"),
    ("seal:custody", "发起与接收印章移交", "records_seal"),
    ("seal:apply", "提交用印申请", "records_seal"),
    ("seal:execute", "执行已审批用印", "records_seal"),
    ("seal:execute_override", "紧急越权执行用印", "records_seal"),
    ("signature:read", "查看电子签署证据", "records_seal"),
    ("signature:write", "创建电子签署信封", "records_seal"),
    ("signature:manage", "维护签章服务声明", "records_seal"),
    ("signature:dispatch", "发送电子签署信封", "records_seal"),
    ("workforce:read", "查看员工、排班、考勤、绩效与资质", "workforce"),
    ("supply:read", "查看供应商、采购、库存与外包", "supply"),
    ("supplier:manage", "管理供应商与园区服务范围", "supply"),
    ("supplier:credential", "管理供应商资质脱敏证据", "supply"),
    ("procurement:request", "发起采购申请", "supply"),
    ("procurement:approve", "同步采购审批结果", "supply"),
    ("procurement:order", "管理采购订单与确认", "supply"),
    ("inventory:manage", "管理物料、仓库与收货", "supply"),
    ("inventory:issue", "申请、发放和退还库存", "supply"),
    ("inventory:adjust", "盘点、调整和冲销库存", "supply"),
    ("outsourcing:manage", "管理外包服务订单与执行", "supply"),
    ("outsourcing:accept", "验收外包服务并评价供应商", "supply"),
    ("engagement:read", "查看政策、企业服务、园区活动与公告", "engagement"),
    ("engagement:policy_manage", "维护并发布园区政策", "engagement"),
    ("engagement:service_manage", "维护企业服务目录与服务案件", "engagement"),
    ("engagement:service_request", "以企业主体发起和确认服务申请", "engagement"),
    ("engagement:activity_manage", "维护园区活动与签到证据", "engagement"),
    ("engagement:activity_register", "以企业主体报名和评价园区活动", "engagement"),
    ("engagement:announcement_manage", "维护、发布并分发园区公告", "engagement"),
    ("workforce:manage", "维护员工生命周期与身份绑定", "workforce"),
    ("workforce:schedule", "维护班次与排班", "workforce"),
    ("workforce:attendance_admin", "维护考勤规则并生成汇总", "workforce"),
    ("workforce:attendance_punch", "提交员工打卡", "workforce"),
    ("workforce:attendance_adjust", "复核并调整考勤异常", "workforce"),
    ("workforce:leave_request", "提交与取消请假", "workforce"),
    ("workforce:leave_review", "查看请假审批结果", "workforce"),
    ("workforce:performance_manage", "维护绩效周期与目标", "workforce"),
    ("workforce:performance_review", "提交与发布绩效评价", "workforce"),
    ("workforce:performance_acknowledge", "确认本人绩效评价", "workforce"),
    ("workforce:qualification_manage", "维护资质类型与员工资质", "workforce"),
    ("workforce:qualification_verify", "核验、撤销与扫描员工资质", "workforce"),
    ("iot:alarm_manage", "处置 IoT 告警", "facility_ops"),
    ("iot:alarm_sweep", "执行 IoT 告警升级扫描", "facility_ops"),
    ("tenant_service:principal_manage", "维护租户服务主体", "tenant_service"),
    ("tenant_service:request", "提交租户服务请求", "tenant_service"),
    ("tenant_service:read_own", "查看本企业服务请求", "tenant_service"),
    ("tenant_service:quote_decide", "确认本企业工单报价", "tenant_service"),
    ("tenant_service:accept", "验收本企业工单", "tenant_service"),
    ("tenant_service:rate", "评价本企业工单", "tenant_service"),
    ("collection:read", "查看催缴案件", "collection"),
    ("collection:write", "维护催缴案件", "collection"),
    ("collection:run", "执行自动分级催缴", "collection"),
    ("receivable:adjust", "申请与应用应收调整", "collection"),
